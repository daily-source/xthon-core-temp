...
const config = merge(base, {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env.SITE_DOMAIN': JSON.stringify(process.env.SITE_DOMAIN),
      ...
      'process.env.AUTH0_LOGOUT_URL': JSON.stringify(process.env.AUTH0_LOGOUT_URL),
      'process.env.NODE_ENV': JSON.stringify(process.env.NODE_ENV || 'development'),
      'process.env.VUE_ENV': '"client"',
      'process.env.BASE_API': JSON.stringify(process.env.BASE_API),
      'process.env.CMS_API': JSON.stringify(process.env.CMS_API),
