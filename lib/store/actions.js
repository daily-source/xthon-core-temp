...
export default {
  ...
  FETCH_ALL_FUNDRAISERS: ({ commit, dispatch, state }, { filter }) => {
    return new Promise((resolve, reject) => {
      return fetchAllFundraisers(filter)
        .then(data => {
          commit("SET_ALL_FUNDRAISERS", { fundraisers: data })
          resolve(data)
        })
        .catch(err => {
          reject(err)
  ...
  FETCH_ALL_FUNDRAISERS_ADMIN: ({ commit, dispatch, state }, { filter, token }) => {
    return new Promise((resolve, reject) => {
      return fetchAllFundraisersAdmin(filter, token)
        .then(data => {
          commit("SET_ALL_FUNDRAISERS_ADMIN", { fundraisers: data })
          resolve(data)
        })
        .catch(err => {
          reject(err)
  ...
  FETCH_ALL_CLAIMS_ADMIN: ({ commit, dispatch, state }, { filter, token }) => {
    return new Promise((resolve, reject) => {
      return fetchAllClaimsAdmin(filter, token)
        .then(data => {
          commit("SET_ALL_CLAIMS_ADMIN", { claims: data })
          resolve(data)
        })
        .catch(err => {
          reject(err)
  ...
  FETCH_ALL_USERS_ADMIN: ({ commit, dispatch, state }, { filter, token }) => {
    return new Promise((resolve, reject) => {
      return fetchAllUsersAdmin(filter, token)
        .then(data => {
          commit("SET_ALL_USERS_ADMIN", { users: data })
          resolve(data)
        })
        .catch(err => {
          reject(err)
  ...
  */
  ...
  SAVE_CLAIM_STATUS: ({ commit, dispatch, state }, { location, route, value }) => {
    return new Promise((resolve, reject) => {
      saveClaimStatus(location, value, route, state.user.tokenData.accessToken)
        .then(data => {
          commit("SAVE_CLAIM_STATUS", { location: location, value: value })
          resolve(data)
        })
        .catch(err => {
          reject(err)
  ...
  SAVE_USER_ACCOUNT_TYPE: ({ commit, dispatch, state }, { location, route, value }) => {
    return new Promise((resolve, reject) => {
      saveUserAccountType(location, value, route, state.user.tokenData.accessToken)
        .then(data => {
          resolve(data)
        })
        .catch(err => {
