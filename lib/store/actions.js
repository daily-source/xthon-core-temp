...
export default {
  ...
  WRITE_COMMENT: ({ commit, dispatch, state }, { comment, reply, fundraiserId, userId, honeypot }) => {
    return new Promise((resolve, reject) => {
      return sendComment(comment, reply, fundraiserId, userId, honeypot)
        .then(data => {
  ...
  UPDATE_USER_FIELD: ({ commit, dispatch, state }, { id, field, value }) => {
    return new Promise((resolve, reject) => {
      return updateUserField(id, field, value)
        .then(res => {
  ...
  SAVE_INLINE_FIELD: ({ commit, dispatch, state }, { location, route, value }) => {
    return new Promise((resolve, reject) => {
      saveInlineField(location, value, route)
        .then(data => {
  ...
  ADD_NEW_UPDATE: ({ commit, dispatch, state }, { fundraiserId, content, userId }) => {
    return new Promise((resolve, reject) => {
      addNewUpdate(fundraiserId, content, userId)
        .then(data => {
