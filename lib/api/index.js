 ...
 */
export function sendComment (commentBody, inReplyTo, fundraiserId, userId, honeypot) {
  return new Promise((resolve, reject) => {
    Vue.axios.post(`${baseURL}/comments/fundraiser/${fundraiserId}`, {
      comment: commentBody,
      parentId: inReplyTo,
      userId: userId,
...
export function updateUserField (id, field, value, token) {
  console.log('trying to updatexx? ', id, field, value, token)
 ...
 */
// WIP.
export function saveInlineField (location, value, route) {
  return new Promise((resolve, reject) => {
    // TODO
    // This call requires authentication and authorization token in the call

    // TODO
    // do a different call depending on the 'location'
    Vue.axios.put(`${baseURL}/${route.name}s/${route.name === "nonprofit" ? route.params.ein : route.params.id}/update`, {
      location: location,
      value: value
    })
      .then(data => {
 ...
 */
// WIP.
export function addNewUpdate (fundraiserId, update, userId) {
  return new Promise((resolve, reject) => {
    // TODO
    // This call requires authentication and authorization token in the call
    Vue.axios.post(`${baseURL}/updates/fundraiser/${fundraiserId}`, {
      content: update,
      userId: userId
    })
      .then(data => {
