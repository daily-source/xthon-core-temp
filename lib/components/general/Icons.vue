<template>
  <div class="icon-wrapper">
    ...
    <svg :style="{width: `${iconwidth}`, height: `${iconheight}`}" viewBox="0 0 24 24" v-if="icon === 'alert'">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" :style="{width: `${iconwidth}`, height: `${iconheight}`}" v-if='icon === "gear"' viewBox="0 0 24 24">
