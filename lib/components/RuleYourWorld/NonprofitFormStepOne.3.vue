    ...
    <form @submit.prevent='formSubmit'>
      <div class="nonprofit-form__container">
        ...
        <div class="nonprofit-form-step-one__percentiles">
          <percentile-table />
          <p>The numbers above fully adjust for costs of living, so $1,000 buys the same amount <br /> in every country. To learn how experts can easily calculate this, click <a href="#">here</a>.</p>
        </div>
      </div>
    </form>
  </div>
