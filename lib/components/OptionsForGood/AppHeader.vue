      ...
      <div class="header__inner">
        ...
        <div class="logo__wrapper">
          <router-link to="/" exact>
            <img class="logo" :src="require('@/assets/img/logo.png')" alt="logo" width="300" height="53">
          </router-link>
        </div>
            ...
            <ul class="other-max-good-sites">
              <li>
                ...
                <ul class="sub" :class="{ 'active': showingMaxGoodSites }">
                  <li v-for="(site, index) in maxGoodSites" :key='index'><a :href="site.href" target="_blank">{{ site.name }}</a></li>
                </ul>
              </li>
            </ul>
          </div>
