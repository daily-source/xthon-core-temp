...
import IncomeLevelsSliderImages from 'Components/0to100/IncomeLevelsSliderImages.3'
import IncomeLevelsSliderList from 'Components/0to100/IncomeLevelsSliderList.3'
...
export default {
    ...
    ...mapGetters({
      topIncomeLevels: 'incomeLevels3/topHalf', 
      bottomIncomeLevels: 'incomeLevels3/bottomHalf', 
		}),

		...mapState({
			labels: state => state.incomeLevels3.labels,	
		})
	}
}
</script>
