...
import IncomeLevelsSliderList from 'Components/0to100/IncomeLevelsSliderList.4'
...
export default {
    ...
    ...mapGetters({
      topIncomeLevels: 'incomeLevels4/topHalf', 
      bottomIncomeLevels: 'incomeLevels4/bottomHalf', 
		}),

		...mapState({
			labels: state => state.incomeLevels4.labels,	
		})
	}
}
</script>
